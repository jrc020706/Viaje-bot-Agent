"""
Busqueda de imagenes y resumenes de destinos.

Encuentra imagenes de un destino combinando DuckDuckGo Images y, como
respaldo, Wikipedia/Wikimedia. Tambien trae un resumen corto del lugar.
Filtra banderas, escudos, mapas y SVGs para quedarse con fotos turisticas.

search_destination_images() es la funcion publica que usan la tool
`place_image_search` y el endpoint /destination-media.
"""
...
from .helpers import _retry, _clean_destination_name, _get_image_search_variants
